...
export default function GameCard({
    ...
    return (
        ...
        >
            ...
            {/* Top: Meta pills */}
            <div className="relative z-10 flex items-center gap-2 px-6 pt-6 flex-wrap">
                {badge && (
                    <span
                ...
                <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-white/8 text-white/45 border border-white/10">
                    {players}
                </span>
                <span className="text-xs font-medium px-2.5 py-0.5 rounded-full bg-white/8 text-white/45 border border-white/10">
                    ★ {difficulty}
            ...
            <div className="relative z-10 flex items-center gap-4 px-6 pt-4 pb-7">
                ...
                {/* RIGHT: Icon */}
                <div
                    className="shrink-0 w-22 h-22 rounded-3xl flex items-center justify-center"
                    style={{
